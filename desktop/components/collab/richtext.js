...
var defaultWidth = "100%";//500;
var defaultHeight = "100%";//200;
var allRTEs = "";
var currentRTE = "";
var selectionText = "";
var rng;
...
function writeRichText(rte) {
	try {
		...
		document.writeln('<table width="' + rte.width + '" cellpadding="0" cellspacing="0" style="height:100%";>');
		document.writeln('	<tr>');
		document.writeln('		<td>');
		if (toolbar1Enabled && rte.toolbar1) {
			document.writeln('		<table class="rteBack" cellpadding="2" cellspacing="0" id="toolbar1_' + rte.rteID + '" width="100%" height="32px">');
			document.writeln('			<tr>');
		...
		if (rte.toolbar2) {
			document.writeln('		<table class="rteBack" cellpadding="0" cellspacing="0" id="toolbar2_' + rte.rteID + '" width="100%" height="32px">');
			document.writeln('			<tr>');
...
//			document.writeln('				<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
		...
		document.writeln('			<iframe id="' + rte.rteID + '" name="' + rte.rteID + '" src="' + includesPath + 'blank.htm" frameborder="0" style="width: 100%; height: calc(100% - 72px); margin: 0; padding: 0;"></iframe>');
		document.writeln('		</td>');
		document.writeln('	</tr>');
		document.writeln('</table>');
