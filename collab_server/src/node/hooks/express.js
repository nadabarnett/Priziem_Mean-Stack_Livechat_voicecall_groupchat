...
exports.createServer = function () {
    ...
    console.log("Doc Collab Server version is " + settings.getEpVersion()
                + " (" + settings.getGitCommit() + ")");

    exports.restartServer();

    if (settings.ssl) {
        console.log("Doc Collab Server instance at https://" + settings.ip + ":" + settings.port + "/");
    } else {
        console.log("Doc Collab Server instance at http://" + settings.ip + ":" + settings.port + "/");
    }
